...
public class RecieveHeartbeat extends AppCompatActivity {
    ...
    // bluetooth code ends , now there are additions on onCreate
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //bluetooth additional onCreate code

}

//bluetooth additional code to be tried
...
//***remember the conncction will fail and app will crash if you haven't paired first
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        if(Build.VERSION.SDK_INT > Build.VERSION_CODES.JELLY_BEAN_MR2){
            ...
            mBluetoothConnection = new BluetoothConnectionService(RecieveHeartbeat.this);
        }
    }
